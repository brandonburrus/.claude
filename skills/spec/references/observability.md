...
Consulted from the spec skill (SKILL.md routes here): standalone observability design, or the deepener for tech-spec phase 5 (performance and reliability) and the rollout and observability section.
