...
4. **Clarify if needed.** When the issue needs fleshing out and the reporter is the user themselves, run interrogate; when the reporter is external, the questions go into a needs-info comment instead.
