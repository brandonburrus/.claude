...
description: >-
  ...
  (use decompose), for fixing the bug itself (use fix), or for prioritization
...
4. **Clarify if needed.** When the issue needs fleshing out and the reporter is the user themselves, interrogate per clarify; when the reporter is external, the questions go into a needs-info comment instead.
