...
4. **Skip the polish, deliberately.** No tests, no error handling beyond runnable, no abstractions, no polish pass with the design skill. These are not corners cut; they are the speed the prototype buys.
