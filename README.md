...
The individual skills auto-load per stage as work matches them, and `review-metrics` closes the loop by measuring a launch against the spec's success metrics so the next cycle starts from evidence.
